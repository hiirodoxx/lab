...
st.markdown(
    ...
    <style>
    .stApp {{
        background: url("https://static.vecteezy.com/system/resources/thumbnails/002/549/751/small_2x/business-candle-stick-graph-chart-of-stock-market-investment-trading-on-blue-background-bullish-point-trend-of-graph-eps10-illustration-vector.jpg");
