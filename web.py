...
st.markdown(
    ...
    <style>
    .stApp {{
        background: url("https://media.istockphoto.com/id/1553638832/vector/business-coin-stock-and-arrow-up-technology-on-blue-background-investment-profit-income.jpg?s=612x612&w=0&k=20&c=X7ycYQgfKlMUnCeaLFR15NeywbQRF7nJZ-JLoBGYj24=");
